        ...
        <section className='my-10'>
            ...
            <div style={{backgroundImage: `url(${image})`}} className={style.rsvp}>
                ...
                <form 
                    ...
                    <h3 style={{textShadow: '2px 2px #065f46'}} className='text-5xl playfair text-center py-5'>RSVP</h3>
                ...
                <div className='relative z-10'>
                    <h1 style={{textShadow: '2px 2px #065f46'}} className='text-5xl playfair text-center py-5 '>GIFT</h1>
