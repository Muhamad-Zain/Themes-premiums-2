    ...
    return(
        <section className='py-10 px-2 sm:px-20'>
            ...
            <div className='relative z-10  p-5'>
                <h3 className='text-2xl sm:text-4xl playfair italic font-bold' style={{textShadow: '1px 1px black'}}>{data?.name?.namaLengkap?.mens}</h3>
            ...
            <div className='flex justify-center items-center py-5 text-5xl playfair'>
                <div className='border-b-2 border-[#8b5e3c] w-10 pr-2' />&<div className='border-b-2 border-[#8b5e3c] w-10 pl-2' />
            </div>
            <AnimatedSection>
            ...
            <div className='relative z-10 text-end p-5'>
                <h3 className='text-2xl sm:text-4xl playfair italic font-bold'  style={{textShadow: '1px 1px black'}}>{data?.name?.namaLengkap?.grils}</h3>
