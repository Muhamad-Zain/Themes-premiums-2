            ...
            <div className='relative z-20 w-full  text-center'>
                ...
                <div className='mt-[40vh]'>
                    ...
                    <div className='flex justify-center'>
                        <button onClick={()=> {btnLocal(), btn()}} disabled={disable} className='flex justify-center items-center bg-green-900 bg-opacity-90 p-2 px-4 border border-white rounded-full playfair'>
